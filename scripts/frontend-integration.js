 ...
 * This file demonstrates how to integrate Swapcore with a web frontend
 */

// For React/Vue/Angular applications
export class SwapcoreClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SwapcoreClient(provider, contractAddress);
